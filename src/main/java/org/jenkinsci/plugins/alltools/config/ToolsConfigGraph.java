 ...
 */
public class ToolsConfigGraph implements Serializable {
    /** Serial version UID. */
    ...
    private boolean displayFalseAlarmSeverity;


    public ToolsConfigGraph() {
    }

    public ToolsConfigGraph(int xSize, int ySize, int numBuildsInGraph,
            ...
            boolean displayPortabilitySeverity, boolean displayFalseAlarmSeverity) {
        this.xSize = xSize;
        this.ySize = ySize;
        ...
        this.displayFalseAlarmSeverity = displayFalseAlarmSeverity;
    }
    ...
    public boolean isDisplayFalseAlarmSeverity() {
        return displayFalseAlarmSeverity;
    }
}
