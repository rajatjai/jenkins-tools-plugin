 ...
 */
public class ToolsConfigSeverityEvaluation implements Serializable {
    /** Serial version UID. */
    ...
    private boolean severityFalseAlarm = true;

    public ToolsConfigSeverityEvaluation() {
    }

    public ToolsConfigSeverityEvaluation(String threshold, String newThreshold,
            ...
            boolean severityPortability, boolean severityFalseAlarm) {
        ...
        this.severityFalseAlarm = severityFalseAlarm;
    }
    ...
    public boolean isSeverityFalseAlarm() {
        return severityFalseAlarm;
    }
}
